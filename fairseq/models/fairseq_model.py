...
class SuperFairseqEncoderDecoderModel(FairseqEncoderDecoderModel):
    ...
    def set_sample_config(self, config, arch_embeds):
        self.encoder.set_sample_config(config, arch_embeds=arch_embeds)
        self.decoder.set_sample_config(config, arch_embeds=arch_embeds)
